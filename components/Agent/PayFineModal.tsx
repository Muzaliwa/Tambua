...
const PayFineModal: React.FC<PayFineModalProps> = ({ onClose }) => {
      ...
      case 'search':
        return (
          <form onSubmit={handleSearch} className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">Entrez le numéro de plaque d'immatriculation pour trouver les amendes associées.</p>
            <div className="relative max-w-sm mx-auto">
              <input
                type="text"
                value={plate}
                onChange={(e) => setPlate(e.target.value)}
                placeholder="Ex: GOM 123 AB"
        ...
        return (
            <div className="p-6 bg-gray-50 text-center">
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-center gap-3">
                    ...
                    <button onClick={handleReset} className="px-6 py-3 font-semibold text-gray-800 bg-gray-200 rounded-lg hover:bg-gray-300">
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-40 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full">
        <ModalHeader title="Paiement d'une Amende" onClose={onClose} color="red" />
        {renderStep()}
      </div>
    </div>
  );
